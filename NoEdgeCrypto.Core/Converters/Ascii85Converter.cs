...
{
    /// <summary>
    /// Methods for converting byte arrays to/from ASCII85. Based on the ASCII85 implementation
    /// found at http://www.codinghorror.com/blog/archives/000410.html
    /// </summary>
    public class Ascii85Converter
    {
        private static readonly Ascii85 _ascii85 = new Ascii85 { LineLength = 0 };

        /// <summary>
        /// Converts an ASCII85 string to a byte array.
        /// </summary>
        /// <param name="ascii85">The ASCII85 input.</param>
        /// <returns>The byte array.</returns>
        public static byte[] Ascii85ToBytes(string ascii85)
        {
            if (ascii85 == null)
            {
                return null;
            }
            return _ascii85.Decode(ascii85);
        }
        ...
        public static string BytesToAscii85(byte[] bytes)
        {
            return _ascii85.Encode(bytes);
        }
